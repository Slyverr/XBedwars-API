package com.slyvr.xbedwars.api.user.wallet;
...
public final class UserCurrency {
    ...
    public static final UserCurrency xbedwars_COINS = new UserCurrency(GameRewardType.xbedwars_COINS);
    ...
    static {
        UserCurrency.register(xbedwars_COINS);
    }
    ...
    public String getName(@NotNull Language lang) {
        ...
        String custom = lang.getCustomMessagePattern("xbedwars.user.currency." + name_key);
