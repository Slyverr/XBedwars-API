package com.slyvr.xbedwars.api.reward;
...
public final class GameRewardType {
    ...
    public static final GameRewardType xbedwars_EXPERIENCE = new GameRewardType("xbedwars Experience", ChatColor.AQUA);

    public static final GameRewardType xbedwars_COINS = new GameRewardType("xbedwars Coins", ChatColor.GOLD);

    private static final Map<String, GameRewardType> BY_NAME = new LinkedHashMap<>();

    static {
        GameRewardType.register(xbedwars_EXPERIENCE);
        GameRewardType.register(xbedwars_COINS);
    }
    ...
    public String getName(@NotNull Language lang) {
        ...
        String custom = lang.getCustomMessagePattern("xbedwars.game.reward." + name.replace(' ', '_'));
